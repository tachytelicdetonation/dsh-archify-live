...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    // ── path matching ────────────────────────────────────────────────────────
    // Mirrors `lib/focus.js`, which is the source of truth and is what `npm test`
    // exercises. Duplicated rather than imported because the host module cannot cross
    // into the browser bundle; `test/test.js` asserts the two agree.
